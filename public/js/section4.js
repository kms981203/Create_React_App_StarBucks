$(function(){
	var section2Top = $('#section4').offset().top-400;
	...
	function ani2Fn(){
		if( $(window).innerWidth() > 960 ){	
			...
			$('.section4-ani1').stop().animate({top:-1000,marginLeft:0, opacity:0},0).animate({top:0,marginLeft:0, opacity:1},1000);
			$('.section4-ani2').stop().animate({top:1000,marginLeft:0, opacity:0},0).animate({top:0,marginLeft:0, opacity:1},1000);			
		}
	}
